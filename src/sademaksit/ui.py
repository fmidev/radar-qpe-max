...
@click.option('-i', '--input-glob', metavar='PATTERN', help=('glob pattern of the input data. '
                                                         'Available variables: {yyyy}, {mm}, {dd}, {date}'))
...
def cli(yyyymmdd, input_glob, output_dir, size, resolution, dbz_field, window):
